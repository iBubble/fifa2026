...
> 
> [!TIP]
> **5. 多源比分共识同步与单向递增流控 (Consensus Sync & Monotonic Flow Control)**
...
> 
> [!IMPORTANT]
> **6. 官方体彩赔率同步与 Circuit Breaker 风控熔断器 (Odds Sync & Circuit Breaker)**
...
> 
> [!NOTE]
> **7. 自适应通用型助手与场景隔离法则 (Adaptive General Assistant & Scene Isolation)**
...
* **后端 (Backend)**：Go (1.22-alpine) 核心服务 / Gin Web 框架 / 跨平台纯 Go 驱动 SQLite（**高并发 WAL 模式部署**，配置忙等待重试以解决高频 LiveSync 读写锁冲突）。
